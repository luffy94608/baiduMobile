...
class HaloRedis {
    ...
    const WECHAT_SUITE_TOKEN_TAG = 'suite_token';
    const WECHAT_SUITE_TICKET = 'suite_ticket';
    const WECHAT_CORP_TOKEN_TAG = 'suite_corp_token';
    const WECHAT_SUITE_PRE_CODE = 'suite_pre_code';
    const WECHAT_JS_API_TICKET = 'wechat_js_api_ticket';
